...
<div class="row justify-content-center">
    <div class="col-lg-7">
        ...
        <div class="d-flex align-items-center gap-2 mb-4">
            ...
            <div>
                <h4 class="mb-0 fw-bold">Nuevo Paramédico</h4>
                <small class="text-muted">Se creará una cuenta de acceso para el paramédico</small>
            </div>
        </div>
        ...
        <form action="{{ route('paramedicos.store') }}" method="POST" novalidate>
            @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="ap_paterno"
                                ...
                                value="{{ old('ap_paterno') }}" placeholder="Apellido paterno"
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Apellido Materno <span class="text-muted small">(opcional)</span></label>
                            <input type="text" name="ap_materno"
                                class="form-control @error('ap_materno') is-invalid @enderror"
                                value="{{ old('ap_materno') }}" placeholder="Apellido materno"
                                style="text-transform:capitalize">
                            @error('ap_materno')
                                <div class="invalid-feedback"><i class="bx bx-error-circle me-1"></i>{{ $message }}</div>
                            @enderror
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-1"></i> Crear Paramédico
                </button>
